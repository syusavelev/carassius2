...
namespace PNEditorReduction
{
    ...
    {
        public VPlace MyClone()
        {
            VPlace temp = (VPlace)MemberwiseClone();
            temp.syncPlace = (Place)syncPlace.MyClone();
            temp._numberOfTokens = _numberOfTokens;
            temp.TokensList = new List<Ellipse>(TokensList);
            temp.NumberOfTokensLabel = new Label();
            temp.NumberOfTokensLabel.Content = NumberOfTokensLabel.Content;
            return temp;
        }
    ...
    {
        public VTransition MyClone()
        {
            VTransition temp = (VTransition)base.MyClone();
            temp.syncTransition = (Transition)syncTransition.MyClone();
            temp._priority = _priority;
